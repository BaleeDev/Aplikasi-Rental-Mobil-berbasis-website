...
if(isset($_POST['submit'])){
	...
	$query = mysqli_query($koneksidb, "SELECT max(kode_booking) as kodeTerbesar FROM booking");
...
//insert
$sql = "INSERT INTO `booking` (`kode_booking`, `id_mobil`, `tgl_mulai`, `tgl_selesai`, `durasi`, `driver`, `status`, `email`, `pickup`, `tgl_booking`, `bukti_bayar`) VALUES ('$kodeBarang', '$vid', '$fromdate', '$todate', '$durasi', '$biayadriver', '$status', '$email', '$pickup', '$tgl', '');";
...
if($query){
		...
		$sql1	="INSERT INTO cek_booking (kode_booking,id_mobil,tgl_booking,status)VALUES('$kodeBarang','$vid','$tglhasil','$status')";
		$query1 = mysqli_query($koneksidb,$sql1);
	
	echo " <script> alert ('Mobil berhasil disewa.'); </script> ";
	echo "<script type='text/javascript'> document.location = 'booking_detail.php?kode=$kodeBarang'; </script>";
	}else{
